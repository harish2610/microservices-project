...
* The original package name 'com.in28minutes.microservices.spring-cloud-config-server' is invalid and this project uses 'com.in28minutes.microservices.springcloudconfigserver' instead.
